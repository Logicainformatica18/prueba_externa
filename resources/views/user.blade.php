            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post" role="form" id="user" name="form">
                        ...
                        Dni<input name="dni" type="number" class="form-control" required>
                        Paterno<input name="firstname" type="text" class="form-control" required>
                        Materno<input name="lastname" type="text" class="form-control" required>
                        Nombres<input name="names" type="text" class="form-control" required>
                        {{-- Celular<input type="number" name="cellphone" class="form-control" required> --}}
                        Título<input type="text" name="title" class="form-control" required>
                        Descripción<input type="text" name="description" class="form-control" required>
